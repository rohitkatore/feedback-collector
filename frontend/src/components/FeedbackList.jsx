  ...
  if (feedbacks.length === 0) {
    return (
      ...
      >
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-2">No feedback submissions yet</h3>
        <p className="text-gray-500 max-w-xs mx-auto">Submissions will appear here once users share their thoughts</p>
      </motion.div>
    )
  }
